...
describe("Blockchain", () => {
  ...
  describe("isValidCain()", () => {
    ...
    describe("when the chain starts with the genesis block and has mustiple blocks", () => {
      beforeEach(() => {
  ...
  describe("replaceChain()", () => {
    ...
    describe("when the new chain is longer", () => {
      ...
      describe("and the chain chain is invalid", () => {
        beforeEach(() => {
    ...
    describe("and the chain chain is valid", () => {
      beforeEach(() => {
        blockchain.replaceChain(newChain.chain);
      });
      ...
      it("logs about the chain reqlacement", () => {
        expect(errorMock).toHaveBeenCalled();
      });
    });
  });
  ...
  describe("validTransactionData()", () => {
    ...
    describe("and the transaction data has at least one malformed input", () => {
      it("returns false and logs an error", () => {
        ...
        newChain.addBlock({ data: [evilTranaction, rewardTransaction] });
